...
```javascript
import map5d from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map5d@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-map5d/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-map5d/actions/workflows/test.yml?query=branch:v0.2.2
